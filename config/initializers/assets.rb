...
Rails.application.config.assets.precompile += %w( controllers/customer_detail_controller_spec.self.js )
...
Rails.application.config.assets.precompile += %w( customers/CustomerDetailController.self.js )
